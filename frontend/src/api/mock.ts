...
export const clienteMock: Api = {
  ...
  condensar: () => job("condensar", () => ({ mensaje: "Informe condensado: 1.240 → 1.062 palabras (14 % menos); 5 apartado(s)/campo(s) acortados.\nConservados sin cambio: conclusión 2 · consecuencias (pierde cifras o referencias: 1,4)\nSnapshot previo: historial/2026-08-27T12-10-00_02_informe_condensar.md (`deshacer` lo restaura).", resultado: { diff: "--- 02_informe.md (antes)\n+++ 02_informe.md (después)\n@@ -30,1 +30,1 @@\n-Durante nuestra revisión hemos identificado que el proceso es mayoritariamente manual y carece de una plantilla común para la grabación de modificaciones, lo que dificulta la automatización y la trazabilidad de los cambios.\n+Durante nuestra revisión hemos identificado que el proceso es mayoritariamente manual y sin plantilla común, lo que dificulta la automatización y la trazabilidad de los cambios." } })),
